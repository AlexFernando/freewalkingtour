...
const TrekkingTours = ({state, actions, libraries}) => {
    ...
    const pageMPTours = state.source.page[198];
    ...
    return ( 
        ...
        <>
            <ContainerBackgroundTour>
                ...
                <TextContainer>
                    <h1>  Trekking - Hiking - <span>Guided by Locals</span> </h1>
...
export default connect(TrekkingTours);